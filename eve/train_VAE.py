...
if __name__=='__main__':
    ...
    parser.add_argument('--MSA_data_location', type=str, help='File where MSAs are stored')
    parser.add_argument('--protein_name', type=str, help='protein name for MSA')
    ...
    parser.add_argument('--theta_reweighting', type=float, help='Parameters for MSA sequence re-weighting Generally: Prokaryotic and eukaryotic families =  0.2; Viruses = 0.01')
    ...
    msa_location = args.MSA_data_location
