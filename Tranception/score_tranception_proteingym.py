...
def main():
    ...
    parser.add_argument('--mutant_data_location', type=str, help='Path to folder that contains mutantion')
    parser.add_argument('--scoring_location', default='./', type=str, help='Name of folder to write model scores to')
    ...
    DMS_data = pd.read_csv(args.mutant_data_location, low_memory=False)
    ...
    all_scores.to_csv(args.scoring_location, index=False)
